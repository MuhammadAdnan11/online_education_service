        ...
        <div className="row-md-12 mt-5 d-flex mediaquery ">
          ...
          <div className="col-md-3 mt-2 mb-2  px-3">
            ...
            <div className="mt-5">
              ...
              <AiOutlineTwitter className="fs-4 widclass1 iconcolor1"/> <FaFacebookF className="fs-4 widclass1 iconcolor1"/> <TiSocialInstagram className="fs-4 widclass1 iconcolor1"/>
              </span>
              </div>
            </div>
          </div>
          ...
          <div className="vl d-none d-xl-block"></div>
                  ...
                  <div className="col-md-6 mt-5 mediaquery">
                    ...
                    <p className="mt-3 perDescr fs-6">Lorem Ipsn gravida nibh vel velit auctor aliquet.Aenean sollicitudin,
                    ...
                    <p className="perDescr fs-6">Nunc suscipit est fermentum, volutpat velit id, ultrices mauris. Nunc 
                    iaculis efficitur vehicula. Suspendisse malesuada urna et turpis luctus
                     dapibus. Donec ex felis, auctor quis suscipit non, volutpat nec erat et
                      turpis luctus.</p>
                 ...
                 <div className="col-md-2 mt-5 ">
                    ...
                    <span className="p-2 fontsize">{thisInstructor.experience1p1}</span>

                    <h6 className="mt-1 p-2 ">{thisInstructor.experience2h1}</h6>
                    <span className="p-2 fontsize">{thisInstructor.experience2p1}</span>
                    </div>
                 </div>
